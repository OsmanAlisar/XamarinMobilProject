...
namespace OsmanAlisarIdesse.ViewModels
{
    internal class MainPageViewModel
    {
        ...
        private List<MobileDataModel> prsList = new List<MobileDataModel>();
        ICommand onTextChanged;
        ...
        public MainPageViewModel()
        {
            ...
            onTextChanged = new Command(OnTextChanged);
        ...
        public void GetObservalCollection(string filter = "")
        {
            if (filter != "")
            {
                SetPrsListToObserval(this.prsList.FindAll(o => o.CardName.Contains(filter)));
            }
            else
            {
